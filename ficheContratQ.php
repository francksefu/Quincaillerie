...
<div class="topnav">
    ...
    //Nous commencons le processus de fabrication d un contrat
       ...
       $datesCont = htmlspecialchars($_POST["DatesCon"]);
        ...
        insereur($idproduit4, $nomClient, $quantite4, $prixU4, $source4, $prixAU4, $datesCont, $operation);
        insereur($idproduit5, $nomClient, $quantite5, $prixU5, $source5, $prixAU5, $datesCont, $operation);
        insereur($idproduit6, $nomClient, $quantite6, $prixU6, $source6, $prixAU6, $datesCont, $operation);
        insereur($idproduit7, $nomClient, $quantite7, $prixU7, $source7, $prixAU7, $datesCont, $operation);
        insereur($idproduit8, $nomClient, $quantite8, $prixU8, $source8, $prixAU8, $datesCont, $operation);
        insereur($idproduit9, $nomClient, $quantite9, $prixU9, $source9, $prixAU9, $datesCont, $operation);

        insereur($idproduit20, $nomClient, $quantite20, $prixU20, $source20, $prixAU20, $datesCont, $operation);
        insereur($idproduit11, $nomClient, $quantite11, $prixU11, $source11, $prixAU11, $datesCont, $operation);
        insereur($idproduit12, $nomClient, $quantite12, $prixU12, $source12, $prixAU12, $datesCont, $operation);
        insereur($idproduit13, $nomClient, $quantite13, $prixU13, $source13, $prixAU13, $datesCont, $operation);
        insereur($idproduit14, $nomClient, $quantite14, $prixU14, $source14, $prixAU14, $datesCont, $operation);
        insereur($idproduit15, $nomClient, $quantite15, $prixU15, $source15, $prixAU15, $datesCont, $operation);
        insereur($idproduit16, $nomClient, $quantite16, $prixU16, $source16, $prixAU16, $datesCont, $operation);
        insereur($idproduit17, $nomClient, $quantite17, $prixU17, $source17, $prixAU17, $datesCont, $operation);
        insereur($idproduit18, $nomClient, $quantite18, $prixU18, $source18, $prixAU18, $datesCont, $operation);
        insereur($idproduit19, $nomClient, $quantite19, $prixU19, $source19, $prixAU19, $datesCont, $operation);
