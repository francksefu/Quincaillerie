...
<div class="row">
    ...
    <?php // cacher et montre les formulaires d insertion et modification avec la partie de 25%?>
            ...
            <button type="button" class="btn btn-primary" onclick="document.getElementById('delet').style.display='block';
            ...
            <a href="approvisionnementQ.php"><button class="btn btn-primary">Approvisionnement</button></a>
            <a href="produit.php"><button class="btn btn-primary">Voir tous vos produits</button></a>
        ...
        <p id="region">
            ...
            if($_SERVER["REQUEST_POST"]=="POST"){
                ...
                $reqSql = ("INSERT INTO `Produit`(`Nom`, PrixAchat, `PrixVente`, PrixVmin, `QuantiteStock`, `DescriptionP`) values('".verifions($_POST["Nom"])."','".verifions($_POST["PrixAchat"])."','".verifions($_POST["PrixVente"])."','".htmlspecialchars($_POST["PrixVmin"])."','".verifions($_POST["QuantiteStock"])."','".verifions($_POST["Description"])."')");
                ...
                $updN=" ";$updPA=" ";$updPV=" ";$updQ=" "; $prixVA; $prixVN;
                if(verifions($_POST["Sorte"])==2){
                    $reqSql= ("SELECT Nom,PrixAchat,PrixVente,QuantiteStock,DescriptionP, PrixVmin FROM Produit WHERE idProduit =".verifions($_POST["Identifiant"])."");
                        ...
                        if(empty(verifions($_POST["PrixVmin"]))){
                            $prixVN = $prixVA;
                        }else{$prixVN=verifions($_POST["PrixVmin"]);}
                       ...
                       $updPA= ("UPDATE `Produit` SET `PrixAchat` = '".$pAAN."' WHERE `Produit`.`idProduit` = ".verifions($_POST["Identifiant"])."");
                        ...
                        $updp = ("UPDATE `Produit` SET `PrixVmin` = '".$prixVN."' WHERE `Produit`.`idProduit` = ".verifions($_POST["Identifiant"])."");
                        ...
                        if(mysqli_query($db,$updp)){echo"<span>Mis a jour fait</span>";}else{
                            echo"Error : ".mysqli_error($db);
                        }
    ...
    <div class="column2">
        ...
        <div class="enveloppe2">
                ...
                <p id="nouvelPP" >
                        ...
                        <input type="float" id="pvmin" name="PrixVmin" placeholder="Prix de vente minimum">
            ...
            <div id="modify" class="hidform">
                <form method= "POST" action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
                    ...
                    PV min <input type="float" id="pvmin" name="PrixVmin" placeholder="Prix de vente minimum"><br>
        ...
        <div class="tableau" style="background-color:#ddd;">
            <?php
                ...
                $reqSql= ("SELECT idProduit, Nom, PrixAchat, PrixVente, QuantiteStock,DescriptionP, PrixVmin FROM Produit order by Nom asc");
                $result= mysqli_query($db, $reqSql);
                if(mysqli_num_rows($result)>0){
