...
<?php 
    ...
    if($cache == "ModifApprov"){
        ...
        $reqSqlo= ("SELECT Approvisionnement.idProduit, Nom, PrixAchat, PrixA, QuantiteApprov, DatesApprov FROM Approvisionnement, Produit WHERE(Approvisionnement.idProduit = Produit.idProduit ) AND (Operation ='".$operaModif."')");
        $resulto= mysqli_query($db, $reqSqlo);
        if(mysqli_num_rows($resulto)>0){
            
             while($rowo= mysqli_fetch_assoc($resulto)){
                $essaie = "".$rowo["idProduit"].": ".$rowo["Nom"]." :".$rowo["PrixAchat"].": USD=PA ";
                array_push($tableauProduit, $essaie); 
                 
                //echo $rowo["QuantiteVendu"];
                array_push($tableauPrix, $rowo["PrixA"]);
                array_push($tableauQuantite, $rowo["QuantiteApprov"]);
                
                $datesVente = $rowo["DatesApprov"];
...
<div class="column1">
    ...
    <div class="column2">
        ...
        <form id="form1" method="POST" action="<?php  echo htmlspecialchars("factureApprov.php"); ?>">
            ...
            <input type = "text" list = "idproduit0" id = "Produit0" name="idProduit0" value="<?php echo $idproduit0; ?>" onchange="clickMoi()" placeholder="Nom du produit ici ...">
            ...
            <input type="number" id="quantite0" name="QuantiteP0" value="<?php echo $quantite0;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit1" id = "Produit1" name="idProduit1" value="<?php echo $idproduit1; ?>" onchange="clickMoi()" placeholder="Nom du produit ici ...">
            ...
            <input type="number" id="quantite1" name="QuantiteP1" value="<?php echo $quantite1;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit2" id = "Produit2" name="idProduit2" value="<?php echo $idproduit2; ?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            ...
            <input type="number" id="quantite2" name="QuantiteP2" value="<?php echo $quantite2;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit3" id = "Produit3" name="idProduit3" value="<?php echo $idproduit3; ?>" onchange="clickMoi()" placeholder="Nom du produit ici ...">
            ...
            <input type="number" id="quantite3" name="QuantiteP3" value="<?php echo $quantite3;?>"placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit4" id = "Produit4" name="idProduit4" value="<?php echo $idproduit4;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            ...
            <input type="number" id="quantite4" name="QuantiteP4" value="<?php echo $quantite4;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit5" id = "Produit5" name="idProduit5" value="<?php echo $idproduit5;?>" onchange="clickMoi()" placeholder="Nom du produit ici ...">
            ...
            <input type="number" id="quantite5" name="QuantiteP5" value="<?php echo $quantite5;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit6" id = "Produit6" name="idProduit6" value="<?php echo $idproduit6;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            ...
            <input type="number" id="quantite6" name="QuantiteP6" value="<?php echo $quantite6;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit7" id = "Produit7" name="idProduit7" value="<?php echo $idproduit7;?>" onchange="clickMoi()" placeholder="Nom du produit ici ...">
            ...
            <input type="number" id="quantite7" name="QuantiteP7" value="<?php echo $quantite7;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit8" id = "Produit8" name="idProduit8" value="<?php echo $idproduit8;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit8">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU8" name="prixU8">
            <input type="number" id="quantite8" name="QuantiteP8" value="<?php echo $quantite8;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit9" id = "Produit9" name="idProduit9" value="<?php echo $idproduit9;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit9">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU9" name="prixU9">
            <input type="number" id="quantite9" name="QuantiteP9" value="<?php echo $quantite9;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit10" id = "Produit10" name="idProduit10" value="<?php echo $idproduit10;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit10">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU10" name="prixU10">
            <input type="number" id="quantite10" name="QuantiteP10" value="<?php echo $quantite10;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit11" id = "Produit11" name="idProduit11" value="<?php echo $idproduit11;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit11">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU11" name="prixU11">
            <input type="number" id="quantite11" name="QuantiteP11" value="<?php echo $quantite11;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit12" id = "Produit12" name="idProduit12" value="<?php echo $idproduit12;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit12">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU12" name="prixU12">
            <input type="number" id="quantite12" name="QuantiteP12" value="<?php echo $quantite12;?>"placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit13" id = "Produit13" name="idProduit13" value="<?php echo $idproduit13;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit13">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU13" name="prixU13">
            <input type="number" id="quantite13" name="QuantiteP13" value="<?php echo $quantite13;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit14" id = "Produit14" name="idProduit14" value="<?php echo $idproduit14;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit14">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU14" name="prixU14">
            <input type="number" id="quantite14" name="QuantiteP14" value="<?php echo $quantite14;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit15" id = "Produit15" name="idProduit15" value="<?php echo $idproduit15;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit15">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU15" name="prixU15">
            <input type="number" id="quantite15" name="QuantiteP15" value="<?php echo $quantite15;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit16" id = "Produit16" name="idProduit16" value="<?php echo $idproduit16;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit16">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU16" name="prixU16">
            <input type="number" id="quantite16" name="QuantiteP16" value="<?php echo $quantite16;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit17" id = "Produit17" name="idProduit17" value="<?php echo $idproduit17;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit17">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU17" name="prixU17">
            <input type="number" id="quantite17" name="QuantiteP17" value="<?php echo $quantite17;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit18" id = "Produit18" name="idProduit18" value="<?php echo $idproduit18;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit18">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU18" name="prixU18">
            <input type="number" id="quantite18" name="QuantiteP18" value="<?php echo $quantite18;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit9" id = "Produit19" name="idProduit19" value="<?php echo $idproduit19;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit19">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU19" name="prixU19">
            <input type="number" id="quantite19" name="QuantiteP19" value="<?php echo $quantite19;?>" placeholder="Mettez ici la quantite...">
            ...
            <input type = "text" list = "idproduit20" id = "Produit20" name="idProduit20" value="<?php echo $idproduit20;?>"onchange="clickMoi()" placeholder="Nom du produit ici ...">
            <datalist id="idproduit20">
                <?php datalist(); ?>
            </datalist>
            <input type="hidden" id="prixU20" name="prixU20">
            <input type="number" id="quantite20" name="QuantiteP20" value="<?php echo $quantite20;?>"placeholder="Mettez ici la quantite...">
